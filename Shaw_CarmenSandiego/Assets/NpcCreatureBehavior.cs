...
public class NpcCreatureBehavior : StateMachineBehaviour
{
    ...
    private void PopulateDialogueOptions()
    {
        for (int a = 0; a < 5; a++)
        {
            couldSay[0, a] = ("cat sidhe option " + a);
        }

        for (int b = 0; b < 5; b++)
        {
            couldSay[1, b] = "cu sidhe option " + b;
        }

        for (int c = 0; c < 5; c++)
        {
            couldSay[2, c] = "aes sidhe option " + c;
        }

        for (int d = 0; d < 5; d++)
        {
            couldSay[3, d] = "Morrigan sidhe option " + d;
        }

        for (int e = 0; e < 5; e++)
        {
            couldSay[4, e] = "kelpie sidhe option " + e;
        }
    }
}
